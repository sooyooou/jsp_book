...
<body>
 ...
 %>님 어서오세요</span>
	...
	<form method="post" name="writeform"
		action="writePro.jsp?booktype=<%=booktype%>"
		onsubmit="return writeSave()" class="write_container">
		...
		<table class="write_table">
				...
				<td>
					<p class="book_chek" id="book_chek">
						<label> <input type="checkbox" name="type"
							value="BestBook" /> 베스트셀러
						</label> <br> <label> <input type="checkbox" name="type"
							value="NewBook" /> 신간 도서
						</label> <br> <label> <input type="checkbox" name="type"
							value="NovelBook" /> 소설
						</label> <br> <label> <input type="checkbox" name="type"
			...
			<tr id="book_image">
				<td><script>
					...
					width="250" height="400" name = "image1"/></td>
			</tr>
			<tr id="write_suc">
				<td><input type="submit" value="작성 완료" class="write_btn"><input
					type="reset" value="다시 작성" class="write_btn"></td>
			</tr>
		</table>
		<%
			} catch (Exception e) {
